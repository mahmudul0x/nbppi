...
export const Route = createFileRoute("/blog/circular-economy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://northbengalpoly.com/blog/circular-economy" },
    ...
    links: [{ rel: "canonical", href: "https://northbengalpoly.com/blog/circular-economy" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://northbengalpoly.com/blog/circular-economy",
