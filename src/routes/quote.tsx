        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-3">
          <aside className="lg:col-span-1">
            <div className="rounded-2xl border border-border bg-card p-7">
              <div className="font-display text-lg font-semibold text-[#082B59]">What you'll get</div>
              <ul className="mt-5 space-y-4 text-sm">
                {[
                  ...
                  <li key={t} className="flex items-start gap-3 text-muted-foreground">
                    <CircleCheck className="mt-0.5 h-4 w-4 shrink-0 text-[#2A9D8F]" />
                    <span>{t}</span>
                  </li>
                ))}
              </ul>
              <div className="mt-8 rounded-xl bg-[#082B59] p-5 text-white">
                <div className="text-xs uppercase tracking-[0.18em] text-white/60">Direct line</div>
                <div className="mt-2 font-display text-lg font-bold">+880 1700 000 000</div>
          ...
          <div className="lg:col-span-2">
            <form className="rounded-2xl border border-border bg-card p-8 md:p-10">
              <div className="font-display text-2xl font-bold text-[#082B59]">B2B Quotation Request</div>
              ...
              <div className="mt-8 grid gap-5 sm:grid-cols-2">
                ...
                <label className="block">
                  <span className="text-xs font-semibold uppercase tracking-[0.16em] text-[#082B59]">Product Type</span>
                  <select className="mt-2 w-full rounded-md border border-border bg-background px-4 py-3 text-sm outline-none transition focus:border-[#2A9D8F] focus:ring-2 focus:ring-[#2A9D8F]/20">
                ...
                <label className="block">
                  <span className="text-xs font-semibold uppercase tracking-[0.16em] text-[#082B59]">Quantity (pcs)</span>
                  <input type="number" min={1000} placeholder="e.g. 100000" className="mt-2 w-full rounded-md border border-border bg-background px-4 py-3 text-sm outline-none transition focus:border-[#2A9D8F] focus:ring-2 focus:ring-[#2A9D8F]/20" />
                </label>
                <label className="block">
                  <span className="text-xs font-semibold uppercase tracking-[0.16em] text-[#082B59]">Printing</span>
                  <select className="mt-2 w-full rounded-md border border-border bg-background px-4 py-3 text-sm outline-none transition focus:border-[#2A9D8F] focus:ring-2 focus:ring-[#2A9D8F]/20">
                    <option>None</option>
                ...
                <label className="block">
                  <span className="text-xs font-semibold uppercase tracking-[0.16em] text-[#082B59]">Lamination</span>
                  <select className="mt-2 w-full rounded-md border border-border bg-background px-4 py-3 text-sm outline-none transition focus:border-[#2A9D8F] focus:ring-2 focus:ring-[#2A9D8F]/20">
                    <option>None</option>
                ...
                <label className="block sm:col-span-2">
                  <span className="text-xs font-semibold uppercase tracking-[0.16em] text-[#082B59]">Project Details</span>
                  <textarea rows={5} placeholder="Specifications, GSM, denier, bag size, timeline..." className="mt-2 w-full rounded-md border border-border bg-background px-4 py-3 text-sm outline-none transition focus:border-[#2A9D8F] focus:ring-2 focus:ring-[#2A9D8F]/20" />
                </label>
                <label className="block sm:col-span-2">
                  <span className="text-xs font-semibold uppercase tracking-[0.16em] text-[#082B59]">Attachment (optional)</span>
