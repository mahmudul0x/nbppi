...
export const Route = createFileRoute("/blog/export-logistics")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://northbengalpoly.com/blog/export-logistics" },
    ...
    links: [{ rel: "canonical", href: "https://northbengalpoly.com/blog/export-logistics" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://northbengalpoly.com/blog/export-logistics",
