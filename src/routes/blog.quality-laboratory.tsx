...
export const Route = createFileRoute("/blog/quality-laboratory")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://northbengalpoly.com/blog/quality-laboratory" },
    ...
    links: [{ rel: "canonical", href: "https://northbengalpoly.com/blog/quality-laboratory" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          image: { "@type": "ImageObject", url: "https://northbengalpoly.com/og-image.jpg", width: 1200, height: 630 },
          author: { "@type": "Person", name: "NBPPI Editorial Team", url: "https://northbengalpoly.com/about" },
          publisher: { "@type": "Organization", name: "NBPPI", logo: { "@type": "ImageObject", url: "https://northbengalpoly.com/logoWebsite.png" } },
          url: "https://northbengalpoly.com/blog/quality-laboratory",
