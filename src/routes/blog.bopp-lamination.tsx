...
export const Route = createFileRoute("/blog/bopp-lamination")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://northbengalpoly.com/blog/bopp-lamination" },
    ...
    links: [{ rel: "canonical", href: "https://northbengalpoly.com/blog/bopp-lamination" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://northbengalpoly.com/blog/bopp-lamination",
