        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-3">
          {[
            ...
            <div key={t} className="rounded-2xl border border-border bg-card p-7">
              <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-[#0A6A38]/10 text-[#0A6A38]">
                <Icon className="h-5 w-5" />
              </div>
              <div className="mt-5 text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">{t}</div>
              <div className="mt-2 whitespace-pre-line font-display text-base font-semibold text-[#0B2D6B]">{v}</div>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-10 overflow-hidden rounded-3xl border border-border bg-white shadow-[var(--shadow-card)] lg:grid-cols-2">
            <div className="p-10 lg:p-14">
              <div className="font-display text-3xl font-bold text-[#0B2D6B]">Quick inquiry</div>
              ...
              <form className="mt-8 grid gap-5 sm:grid-cols-2">
                ...
                <label className="block sm:col-span-2">
                  <span className="text-xs font-semibold uppercase tracking-[0.16em] text-[#0B2D6B]">Message</span>
                  <textarea rows={4} className="mt-2 w-full rounded-md border border-border bg-background px-4 py-3 text-sm outline-none transition focus:border-[#0A6A38] focus:ring-2 focus:ring-[#0A6A38]/20" />
                </label>
            ...
            <div className="relative min-h-[420px] bg-[#0B2D6B]">
              <iframe
